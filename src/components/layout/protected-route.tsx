  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-7xl px-3 md:px-4 pt-3 md:pt-6 pb-2 space-y-3 md:space-y-6">
        ...
        <div className="bg-[var(--surface)] border border-[var(--border-main)] rounded-2xl p-2.5 md:p-3">
          <div className="grid grid-cols-3 gap-1 md:gap-3">
            {[0, 1, 2].map((i) => (
              <div key={i} className="flex items-center gap-2 md:gap-3 rounded-xl bg-[var(--fill-subtle)] px-2.5 py-2 md:px-4 md:py-3">
        ...
        <div className="hidden md:block">
          <div className="grid grid-cols-7 gap-1 mb-2">
            {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((d, i) => (
              <div key={i} className="text-center text-xs text-[var(--text-muted)] py-2">{d}</div>
            ))}
          </div>
  ...
  if (loading) {
    ...
    return (
      <div className="flex min-h-screen flex-col bg-[var(--app-bg)]">
        {/* Nav skeleton */}
        <div className="border-b border-[var(--border-main)] bg-[var(--surface)]">
        ...
        <div className="md:hidden fixed bottom-0 left-0 right-0 bg-[var(--surface)] border-t border-[var(--border-main)] px-6 py-3">
