          ...
          >
            {CURRENCIES.map((c) => (
              <button
                ...
                className={`w-full flex items-center justify-between px-4 py-2.5 text-left hover:bg-[var(--surface-hover)] transition-colors cursor-pointer ${currency.code === c.code ? 'bg-[var(--surface-hover)]' : ''}`}
              >
