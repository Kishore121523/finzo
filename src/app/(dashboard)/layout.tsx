          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="relative group">
              <button
                ...
                className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-[#03DAC6]/15 text-[#03DAC6] transition-colors hover:bg-[#03DAC6]/25 cursor-pointer"
              >
